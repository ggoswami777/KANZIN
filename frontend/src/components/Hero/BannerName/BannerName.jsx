...
const BannerName = () => {
  return (
    ...
    >
      ...
      <span
        className="relative drop-shadow-[0_0_5px_rgba(0,0,0,0.5)] 
      ...
      <p
        className="text-7xl font-bold text-[#f08bc9] relative drop-shadow-[0_0_5px_rgba(240,139,201,0.5)] 
                   hover:drop-shadow-[0_0_8px_rgba(240,139,201,1)] animate-softFloatDelay"
        style={{ fontFamily: "var(--font-stack)" }}
      >
        カンジン
      </p>

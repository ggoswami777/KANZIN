  ...
  return (
    <>
      <div className="relative min-h-screen w-full overflow-x-hidden ">
        <div className="text-xl z-10 px-3 absolute text-white tracking-[0.2em] mb-6">KANZIN</div>
        <img
        ...
        <motion.div className="relative  flex flex-col items-center text-center pb-20">
          <motion.div variants={SlideLeft(0.3)}
              initial="hidden"
              animate="visible"  className="flex flex-col gap-3  py-12">
            <h1
          ...
          <motion.div variants={SlideUp(0.3)}
              initial="hidden"
              animate="visible"  className="flex flex-col gap-16 w-full items-center text-white/40">
